				...
				<div class="row h-100">
					<div
						...
						<footer
							...
							<a href="#" class="btn orange-border">내 아이디어 제안하기</a> <a href="#"
								class="btn orange-border">다른 아이디어 평가하기</a>
						</footer>
						<!-- .entry-footer -->
					</div>
					<!-- .col -->
								...
								<div class="cause-wrap">
									<figure class="m-0">
										...
										<div
											...
											<a href="#" class="btn gradient-bg mr-2"
												data-cause="cause-link">상세보기</a>
										</div>
										<!-- .figure-overlay -->
									</figure>
									<div class="cause-content-wrap">
										<header
											...
											<h3 class="entry-title w-100 m-0">
												<a href="#" data-cause="cause-name">나는 테스트 프로젝트 이름입니다<!-- PJH_NAME --></a>
											</h3>
										</header>
										<!-- .entry-header -->
										<div class="entry-content">
											<p class="m-0" data-cause="cause-intro">
												나는 테스트 프로젝트 인트로 나는 테스트 프로젝트 인트로 나는 테스트 프로젝트 인트로
												<!-- PJH_INTRO -->
											</p>
										</div>
										<!-- .entry-content -->
											...
											<div class="fund-raised-details">
												...
												<div class="progress">
													<div class="progress-bar" role="progressbar"
														data-cause="cause-moneybar" aria-valuenow="0"
														aria-valuemin="0" aria-valuemax="0"
														style="background-color: #01abaf"></div>
												</div>
											</div>
											<div
						...
						<div class="foot-about">
							<h2>
								<a class="foot-logo" href="#"><img
									src="/clib/images/foot-logo.png" alt=""></a>
							</h2>
